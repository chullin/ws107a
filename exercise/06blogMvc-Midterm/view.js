...
V.list = function (posts, passport) {
  ...
  for (let post of posts) {
    list.push(`<div>第${count}則：<a href='/list/${post.title}/${post.body}'>${post.title}</a></div>`)
    count++
  }
  ...
  <ul id="nav">
    ...
    <li class="a" style="float:right"><a class="active" href="#"><font color="#82FF82"> 目前只用者為：${passport.user}</font></a></li>
  </ul>
